...
public class ResultService {
  ...
  public GetResultsResponse findResultsForLanguage(final String languageName, String jwt)
    ...
    val language =
        languageRepository
            ...
            .orElseThrow(() -> new LangmateRuntimeException(400, "Language not found"));
    ...
    if (results.isEmpty()) {
      log.warn(
          "No results found for userId: {} and language: {}", currentUser.getId(), languageName);
  ...
  public GetResultResponse getResultDetails(final Long resultId) throws LangmateRuntimeException {
    val result =
        resultRepository
            .findById(resultId)
            .orElseThrow(() -> new LangmateRuntimeException(400, "No result found"));
    return new GetResultResponse(
        result.getGrade(), result.getLanguage().getName(), formatter.format(result.getTimestamp()));
  }
